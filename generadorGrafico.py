...
class GeneradorGrafico:
    ...
    def crearGrafico(self):
        ...
        plt.title("INGRESOS Y GASTOS", fontsize=16, fontweight="bold", color="black", fontname="Arial")
        plt.ylabel("EUROS €", fontsize=10,fontname="Arial",color="black",fontweight="bold")
        plt.xticks(ticks=x_positions, labels=self.tags ,color="black",fontsize=9,fontname="Arial")
